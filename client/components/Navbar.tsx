      ...
      {showWalletModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowWalletModal(false)}>
          <div className="w-80 rounded-2xl border border-white/[0.08] bg-[#0c0c1d] shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-5 pt-3 pb-1 space-y-2">                 <p className="text-xs text-white/40 leading-relaxed">New here? Follow these steps to get started:</p>                 <ol className="text-xs text-white/50 leading-relaxed list-decimal list-inside space-y-1">                   <li>Install <a href="https://freighter.app" target="_blank" rel="noopener noreferrer" className="text-[#7c6cf0] hover:underline">Freighter Wallet</a> (free browser extension)</li>                   <li>Create a new wallet inside the extension</li>                   <li>Switch network to <span className="text-[#4fc3f7]">Testnet</span> in Freighter settings</li>                   <li>Get free <a href="https://laboratory.stellar.org/#account-creator?network=test" target="_blank" rel="noopener noreferrer" className="text-[#7c6cf0] hover:underline">Testnet XLM</a> from the faucet</li>                   <li>Come back and select Freighter below</li>                 </ol>               </div><div className="p-3 space-y-1">
